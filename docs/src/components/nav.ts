...
const RAW_NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { icon: 'image',           label: 'Illustrations', route: '#/foundation/illustrations' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'git-fork',          label: 'Tree Combobox',     route: '#/components/tree-combobox'      },
      { icon: 'table',             label: 'Tree Grid Combobox', route: '#/components/tree-grid-combobox' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'circle-dot',     label: 'Aura',     route: '#/effects/aura'     },
      {
        icon: 'image',
        label: 'Standalone Graphics',
        children: [
          { icon: 'zap',                 label: 'Fire',            route: '#/effects/fire' },
          { icon: 'sparkles',            label: 'Snowflakes',      route: '#/effects/snowflakes' },
          { icon: 'activity',            label: 'Fluid Fill',      route: '#/effects/fluid-fill' },
          { icon: 'clock',               label: 'Hourglass',       route: '#/effects/hourglass' },
          ...
          { icon: 'party-popper',        label: 'Fireworks',       route: '#/effects/fireworks' },
        ],
      },
      ...
      { icon: 'layers',            label: 'Content Transition', route: '#/effects/content-transition' },
    ],
  },
  {
    label: 'Utilities',
