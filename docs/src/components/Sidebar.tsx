...
function isNavBranch(item: NavLeaf | NavBranch): item is NavBranch {
...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'gallery-horizontal', label: 'Carousel',          route: '#/components/carousel'       },
      { icon: 'image',              label: 'Lightbox',          route: '#/components/lightbox'       },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'file-text',         label: 'Textarea',          route: '#/components/textarea'           },
      ...
      { icon: 'upload',            label: 'File Upload',       route: '#/components/file-upload',        soon: true },
      ...
      { icon: 'file-text',         label: 'Markdown Editor',   route: '#/components/markdown-editor',    soon: true },
      { icon: 'braces',            label: 'Code Editor',       route: '#/components/code-editor'        },
      { icon: 'file-diff',         label: 'Diff Editor',       route: '#/components/diff-editor',        soon: true },
      { icon: 'map-pin',           label: 'In-place Editor',   route: '#/components/inplace-editor'     },
      { icon: 'pen-line',          label: 'Signature Pad',     route: '#/components/signature-pad',      soon: true },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'folder-open',  label: 'Tabs',              route: '#/components/tabs'            },
      ...
      { icon: 'gamepad-2',    label: 'FAB',               route: '#/components/fab'             },
      { icon: 'menu',         label: 'Navigation Menu',   route: '#/components/nav-menu'        },
      { icon: 'layout',       label: 'Toolbar',           route: '#/components/toolbar'         },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'layout',         label: 'Panel',             route: '#/components/panel'            },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'line-chart',   label: 'Scatter Chart',     route: '#/charts/scatter-chart',         soon: true },
  ...
  },
  {
    label: 'Utilities',
    items: [
      { icon: 'crosshair',      label: 'Focus Directives', route: '#/utils/focus-directives', soon: true },
  ...
  },
  {
    label: 'Playground',
    items: [
      { icon: 'file-text', label: 'Scratch Pad', route: '#/playground/scratch-pad', soon: true },
    ],
  },
];
