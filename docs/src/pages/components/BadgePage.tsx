    ...
    <div className="features-layout">
      <div className="features-main" ref={mainRef}>
        ...
        <section id="variants" className="demo-section" aria-labelledby="variants-heading">
          ...
          <p className="section-desc">Six color variants for different semantic purposes.</p>
        ...
        <section id="sizes" className="demo-section" aria-labelledby="sizes-heading">
          ...
          <p className="section-desc">Three size options to fit different UI contexts.</p>
        ...
        <section id="api" className="demo-section">
          ...
          <div className="api-table-wrap">
            <table className="api-table">
              ...
              <tbody>
                <tr><td><code>variant</code></td><td><code>'default' | 'primary' | 'success' | 'warning' | 'danger' | 'info'</code></td><td><code>'default'</code></td><td>Color variant</td></tr>
