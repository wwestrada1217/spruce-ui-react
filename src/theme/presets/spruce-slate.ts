...
/**
 * Spruce Slate — a cool, corporate flavor of {@link spruceTheme}. Same slate-tinted
 * neutrals, but the evergreen accent is swapped for a deep slate-blue.
 */
export const spruceSlateTheme: SpruceTheme = {
  name: 'spruce-slate',
  displayName: 'Spruce Slate',
  base: 'light',
  tokens: {
    '--sp-primary': '#3a5ba0',
    '--sp-primary-hover': '#324e8a',
    '--sp-primary-active': '#2b4478',
    '--sp-primary-subtle': 'rgba(58, 91, 160, 0.08)',
    '--sp-primary-text': '#f8fafc',
    '--sp-border-focus': '#3a5ba0',

    '--sp-success': '#16a34a',
    '--sp-success-subtle': 'rgba(22, 163, 74, 0.09)',

    '--sp-info': '#2563eb',
    '--sp-info-subtle': 'rgba(37, 99, 235, 0.09)',
    ...
    '--sp-focus-ring-color': 'rgba(58, 91, 160, 0.35)',
    '--sp-focus-glow-color': 'rgba(58, 91, 160, 0.12)',
